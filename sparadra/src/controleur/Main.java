...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        public static void chargement ()throws SaisieException {
            Client c1 = new Client("martin", "Luc", "12 Rue des Lilas", "57000", "Metz", "06 12 34 56 78", "luc.martin@example.com", "123456789012345", "15/06/1980", "Mutuelle A", "Dr Shiva‑Marie Khorsand Taefehnorooz");
            Client c2 = new Client("Durand", "Sophie", "5 Avenue Foch", "57100", "Thionville", "06 23 45 67 89", "sophie.durand@example.com", "234567890123456", "22/11/1975", "Mutuelle B", "Dr Eric Partouche");
            Client c3 = new Client("Leroy", "Pierre", "8 Rue de la Gare", "54110", "Dombasle-sur-Meurthe", "06 34 56 78 90", "pierre.leroy@example.com", "345678901234567", "03/03/1990", "Mutuelle C", "Dr JACQUIER‑MERCIER Marie");
            Client c4 = new Client("Moreau", "Claire", "20 Boulevard des Vosges", "54520", "Laxou", "06 45 67 89 01", "claire.moreau@example.com", "456789012345678", "19/09/1985", "Mutuelle D", "Dr TOURPE Dominique");
            Client c5 = new Client("Dubois", "Julien", "14 Rue Anatole France", "54210", "Saint‑Nicolas‑de‑Port", "06 56 78 90 12", "julien.dubois@example.com", "567890123456789", "10/12/1978", "Mutuelle E", "Dr LIGIER Romain");
            Client c6 = new Client("Petit", "Amélie", "3 Place Saint‑Louis", "57600", "Forbach", "06 67 89 01 23", "amelie.petit@example.com", "678901234567890", "30/05/1982", "Mutuelle F", "Dr Cécile Flye‑Sainte‑Marie");
            Client c7 = new Client("Rousseau", "Antoine", "2 Rue Michel Debré", "57600", "Forbach", "06 78 90 12 34", "antoine.rousseau@example.com", "789012345678901", "25/08/1972", "Mutuelle G", "Dr Ingrid Chiaro");
            Client c8 = new Client("Faure", "Laura", "7 Rue des Grands Champs", "57070", "Vantoux", "06 89 01 23 45", "laura.faure@example.com", "890123456789012", "14/02/1992", "Mutuelle H", "Jean‑Louis Mougenel");
            Client c9 = new Client("Gauthier", "Nicolas", "1A Rue de Verdun", "57120", "Pierrevillers", "06 90 12 34 56", "nicolas.gauthier@example.com", "901234567890123", "05/07/1988", "Mutuelle I", "Dr Alisson ANCEL");
            Client c10 = new Client("Laurent", "Élodie", "20a Rue de la Gare", "57300", "Hagondange", "06 01 23 45 67", "elodie.laurent@example.com", "012345678901234", "12/10/1995", "Mutuelle J", "Dr Claire PIERRON");
            ...
            Mutuelle mu1 = new Mutuelle("Caisse Régional Crédit Agricole Mutuelle Lorraine","56 Avenue André Malraux","57000","Metz","09 64 40 37 11","contact@ca-mutu-elle-lorraine.fr","57",70);
            Mutuelle mu2 = new Mutuelle("Mutuelle Nationale Territoriale - Section Metz","1 rue du Pont Moreau","57000","Metz","03 87 37 58 32","service@mnt.fr","57",75);
            Mutuelle mu3 = new Mutuelle("MNT (Mutuelle Nationale Territoriale) - Agence Mitterrand","16 avenue François Mitterrand","57000","Metz","09 72 72 02 02","metz@mnt.fr","57",75);
            Mutuelle mu4 = new Mutuelle("Mutlor - Les Mutuelles de Lorraine","11 Rue du Colonel Merlin","54400","Longwy","03 82 25 79 00","contact@mutlor.fr","57",65);
            Mutuelle mu5 = new Mutuelle("Mutlor - Les Mutuelles de Lorraine (Nancy)","6 Rue de la Visitation","54000","Nancy","+33 3 83 36 77 07","nancy@mutlor.fr","54",65);
